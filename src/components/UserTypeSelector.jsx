...
/**
 * A component that allows a user to select their role during the signup process.
 *
 * @param {object} props - Component props.
 * @param {('student'|'counselor'|'admin')} props.selectedType - The currently selected user type.
 * @param {(type: 'student'|'counselor'|'admin') => void} props.onSelectType - The function to call when a user type is selected.
 */
export function UserTypeSelector({ onSelectUserType }) {
  const userTypes = [
    {
      type: 'student',
